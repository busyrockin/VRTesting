...
namespace VRTK
{
    ...
    public class VRTK_MoveInPlace : MonoBehaviour
    {
        ...
        public virtual float CalculateListAverage()
        {
            float listAverage = 0;
        ...
        public virtual Quaternion DetermineAverageControllerRotation()
        {
        ...
        public virtual Quaternion AverageRotation(Quaternion rot1, Quaternion rot2)
        {
